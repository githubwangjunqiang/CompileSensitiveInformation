...
public class ItemTouchHelperCallback2<T> extends ItemTouchHelper.Callback {
    ...
    public ItemTouchHelperCallback2(RecyclerView.Adapter adapter, ArrayList<T> dataList) {
        this.adapter = checkIsNull(adapter);
        this.dataList = checkIsNull(dataList);
    }

    public ItemTouchHelperCallback2(RecyclerView.Adapter adapter, ArrayList<T> dataList, OnSlideListener<T> listener) {
        this.adapter = checkIsNull(adapter);
        this.dataList = checkIsNull(dataList);
